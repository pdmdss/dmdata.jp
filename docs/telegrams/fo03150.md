...
[気象庁防災情報XMLフォーマット技術情報 - 警報級の可能性（明々後日以降）の解説](https://dmdata.jp/docs/jma/manual/0315-0315.pdf)
...
2026年05月28日13時以降は、Head/Tileを「明後日以降の警報級の可能性」から「明々後日以降の警報級の可能性」へ変更となりました。Body部の内容に変更はありません。
