...
| 資料名                                    | XML:/Report/Control/Title  | データ種類コード | データ形式 | JSONデータ                                                          | 備考              |
|-------------------------------------------|----------------------------|------------------|------------|---------------------------------------------------------------------|-------------------|
...
| 資料名                                                                             | XML:/Report/Control/Title                  | データ種類コード  | データ形式 | JSONデータ                                                                       | 備考               |
|------------------------------------------------------------------------------------|--------------------------------------------|-------------------|------------|----------------------------------------------------------------------------------|--------------------|
| &#x1f6ab; [特別警報/警報/注意報](we02010)                                          | 気象特別警報・警報・注意報                 | VPWW53            | XML        |                                                                                  | 2028年頃に終了予定 |
| &#x1f6ab; [特別警報/警報/注意報 （新しいステージに対応した防災気象情報）](we02050) | 気象警報・注意報（Ｈ２７）                 | VPWW54            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              | 2028年頃に終了予定 |
| [大雨に関する警戒レベル情報](we02061)                                              | 気象警報・注意報（Ｒ０６）（大雨）         | VPWW55            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [土砂災害に関する警戒レベル情報](we02062)                                          | 気象警報・注意報（Ｒ０６）（土砂）         | VPWW56            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [高潮に関する警戒レベル情報](we02063)                                              | 気象警報・注意報（Ｒ０６）（高潮）         | VPWW57            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [暴風・暴風雪に関する警報・注意報](we02064)                                        | 気象警報・注意報（Ｒ０６）（暴風）         | VPWW58            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [波浪に関する警報・注意報](we02065)                                                | 気象警報・注意報（Ｒ０６）（波浪）         | VPWW59            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [大雪に関する警報・注意報](we02066)                                                | 気象警報・注意報（Ｒ０６）（大雪）         | VPWW60            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [その他の気象注意報](we02067)                                                      | 気象警報・注意報（Ｒ０６）（その他注意報） | VPWW61            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| [警戒・注意事項と各気象要素の時系列予想](we02080)                                  | 気象警報・注意報時系列情報（Ｒ０６）       | VPWP50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning-timeseries.md)   |                    |
| [警戒・注意事項を全要素した全国集約通報](we02069)                                  | 気象警報・注意報（Ｒ０６）（集約通報）     | VPWS50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-warning.md)              |                    |
| &#x1f6ab; [気象特別警報報知](we02020)                                              | 気象特別警報報知                           | VPNO50            | XML        |                                                                                  | 2028年頃に終了予定 |
| &#x1f6ab; [記録的短時間大雨情報](we02030)                                          | 記録的短時間大雨情報                       | VPOA50            | XML        | [配信中](/docs/reference/conversion/json/schema/legacy/weather-warning_1.0.0.md) | 2028年頃に終了予定 |
| &#x1f6ab; [全般気象情報](we02310)                                                  | 全般気象情報                               | VPZJ50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-information.md)          | 2028年頃に終了予定 |
| &#x1f6ab; [地方気象情報](we02320)                                                  | 地方気象情報                               | VPCJ50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-information.md)          | 2028年頃に終了予定 |
| &#x1f6ab; [府県気象情報](we02330)                                                  | 府県気象情報                               | VPFJ50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-information.md)          | 2028年頃に終了予定 |
| [気象防災速報](we02341)                                                            | 府県気象防災速報                           | VPBS50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
| [気象防災速報（潮位）](we02342)                                                    | 府県気象防災速報（潮位）                   | VPBS51            | XML        |                                                                                  | 配信開始時期未定   |
| [全般気象解説情報](we02311)                                                        | 全般気象解説情報                           | VPZJ51            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
| [地方気象解説情報](we02321)                                                        | 地方気象解説情報                           | VPCJ51            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
| [府県気象解説情報](we02331)                                                        | 府県気象解説情報                           | VPFJ51            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
| [全般気象解説情報（潮位）](we02312)                                                | 全般気象防災速報（潮位）                   | VMCJ53            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
| [地方気象解説情報（潮位）](we02322)                                                | 地方気象防災速報（潮位）                   | VMCJ54            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
| [府県気象解説情報（潮位）](we02332)                                                | 府県気象防災速報（潮位）                   | VMCJ55            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-commentary.md)           |                    |
...
| &#x1f6ab; [全般潮位情報](we02210)                                                  | 全般潮位情報                               | VMCJ50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-information.md)          | 2028年頃に終了予定 |
| &#x1f6ab; [地方潮位情報](we02220)                                                  | 地方潮位情報                               | VMCJ51            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-information.md)          | 2028年頃に終了予定 |
| &#x1f6ab; [府県潮位情報](we02230)                                                  | 府県潮位情報                               | VMCJ52            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-information.md)          | 2028年頃に終了予定 |
...
| &#x1f6ab; [土砂災害警戒情報](we02710)                                              | 土砂災害警戒情報                           | VXWW50            | XML        | [配信中](/docs/reference/conversion/json/schema/weather-landslide.md)            | 2028年頃に終了予定 |
| [指定河川洪水予報（氾濫警報・注意報）](we02810)                                    | 指定河川洪水予報                           | VXKOii (ii=50-89) | XML        | [配信中](/docs/reference/conversion/json/schema/weather-river-flood.md)          |                    |
| （新）指定河川洪水予報（未定）                                                     |                                            |                   | XML        | 配信予定                                                                         | 配信開始時期未定   |
| [水位周知河川に関する情報](we02821)                                                | 水位周知河川に関する情報                   | VXSUii (ii=50-59) | XML        | 配信予定                                                                         | 配信開始時期未定   |
...
| &#x1f6ab; [早期注意情報（明日までの警報級の可能性）](fo03050) | 警報級の可能性（明日まで）                                   | VPFD60           | XML        | [配信中](/docs/reference/conversion/json/schema/legacy/forecast-warning-possibility_1.0.0.md) | 2028年頃に終了予定 |
| [早期注意情報（明日までの警報級の可能性）](fo03051)           | 早期注意情報（明日まで）（Ｒ０６）                           | VPFD61           | XML        | [配信中](/docs/reference/conversion/json/schema/forecast-warning-possibility.md)              |                    |
| [府県週間天気予報](fo03130)                                   | 府県週間天気予報                                             | VPFW50           | XML        | [配信中](/docs/reference/conversion/json/schema/forecast-prefecture.md)                       |                    |
| [早期注意情報（明々後日以降の警報級の可能性）](fo03150)       | 警報級の可能性（明後日以降）                                 | VPFW60           | XML        | [配信中](/docs/reference/conversion/json/schema/legacy/forecast-warning-possibility_1.0.0.md) |
...
| [全般海上警報（定時）（Ｈ２９）](sc02110) | 全般海上警報（定時）（Ｈ２９） | VPZU52           | XML        | 2028年頃に終了予定        |
| [全般海上警報（臨時）（Ｈ２９）](sc02110) | 全般海上警報（臨時）（Ｈ２９） | VPZU53           | XML        |                           |
| [全般海上警報（定時）（Ｒ０８）](sc02130) | 全般海上警報（定時）（Ｒ０８） | VPZU54           | XML        | 2026年7月30日より配信開始 |
...
| &#x1f6ab; [台風全般情報（総合情報、上陸等情報）](we02610)                  | 全般台風情報                   | VPTI50                            | XML        | [weather-information v1.0.0](/docs/reference/conversion/json/schema/weather-information.md)                    |                             |
| &#x1f6ab; [台風全般情報（位置、発生情報）](we02620)                        | 全般台風情報（定型）           | VPTI51                            | XML        | [weather-information v1.0.0](/docs/reference/conversion/json/schema/weather-information.md)                    |                             |
| &#x1f6ab; [発達する熱帯低気圧に関する情報](we02620)                        | 全般台風情報（定型）           | VPTI51                            | XML        | [weather-information v1.0.0](/docs/reference/conversion/json/schema/weather-information.md)                    |                             |
| &#x1f6ab; [全般台風情報（位置詳細）](we02630)                              | 全般台風情報（詳細）           | VPTI52                            | XML        | [weather-information v1.0.0](/docs/reference/conversion/json/schema/weather-information.md)                    |                             |
| &#x1f6ab; [台風の暴風域に入る確率](we02690)                                |                                | FXJPii (ii=51-56)                 | A/N        |                                                                                                                |                             |
| &#x1f6ab; [台風の暴風域に入る確率（5日）](we02695)                         |                                | FXJPii (ii=61-72)                 | A/N        |                                                                                                                |                             |
| &#x1f6ab; [地方高温注意情報](we02550)                                      | 地方高温注意情報               | VPCT50                            | XML        |                                                                                                                |                             |
| &#x1f6ab; [大雨危険度通知](sc02070)                                        | 大雨危険度通知                 | VPRN50                            | XML        |                                                                                                                |
| &#x1f6ab; [海上高層実況気象報](ob04120)                                    |                                | U@VX01 (@=E,K,L,P,S) <br/> UGVX20 | A/N        |                                                                                                                | TEMP-SHIP報、PILOT-SHIP報　 |
...
- 2026/08/25 - 初霜、初氷、初冠雪を報ずる特殊気象報の終了に伴う更新
- 2026/06/05 - 全般海上警報(VPZU54)の配信開始日時決定、配信資料に関するお知らせを追加
- 2026/05/28 - 防災情報の改廃に伴う更新
- 2026/05/21 - 配信資料に関するお知らせを追加
- 2026/04/24 - 配信資料に関するお知らせを追加
- 2026/03/30 - 気象警報・注意報(VPWW55-61, VPWS50, VPWP50)、気象防災速報、気象解説情報のJSONデータ仕様公開
- 2026/02/05 - 配信資料に関するお知らせを追加
- 2026/01/29 - 配信資料に関する技術情報 第671号、全般海上警報（定時）（Ｒ０８）を追加
- 2025/12/22 - 解説資料の更新と配信資料に関するお知らせの追加
- 2025/12/17 - XML解説資料の更新
- 2025/08/25 - XML解説資料の更新、付録PDFデータの追加
- 2025/07/10 - 配信資料に関するお知らせを追加
- 2025/06/30 - 解説資料の更新と配信資料に関するお知らせの追加、配信予定の変更と廃止予定の追記
