...
:::caution
* 2026年05月より開始する「気象警報・注意報（Ｒ０６） (VPWW55~61)」、「警戒・注意事項を全要素した全国集約通報 （Ｒ０６）(VPWS50)」を使用する場合は、新しいバージョンを参照してください。<br/>
[weather-warning v1.1.0](/docs/reference/conversion/json/schema/weather-warning.md)

* 2026年05月より開始する「警戒・注意事項と各気象要素の時系列予想 (VPWP50)」を使用する場合は、新しいスキーマを参照してください。<br/>
...
| 2._7.? | condition    | VPWW54の場合のみ出現<br/>発表警報・注意報が<br/>未発表時に出現する  | **String**<br/> 何も警報・注意報を発表していない旨を記載する、`発表警報・注意報はなし`で固定                                                                                                                      |
...
| 5._5.? | condition    | 発表警報・注意報が<br/>未発表時に出現する  | **String**<br/> 何も警報・注意報を発表していない旨を記載する、`発表警報・注意報はなし`で固定                                                  |
...
| 5._3._3.    | status     |       | **String**<br/> 前回発表した気象警報・注意報からの変化を記載する<br/>取りうる値は、 `発表`、`継続`、`特別警報から警報`、`特別警報から注意報`、`警報から注意報`、`解除`            |
...
| 6._2._3._4._3._2._4.? | condition    |                          | **String**<br/> 記載すべき値がない場合、value が **Null** 時では、`値なし` が入る。<br/> その他、気象現象等を表現する文字列が入る場合がある #quantitative-condition |
|                       |              |
