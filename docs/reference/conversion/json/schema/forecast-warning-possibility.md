...
| 1._3._1. | timeDefines   |      | **Array&lt;Object&gt;**<br/> 全ての予想期間を示すとともに、対応する要素の個々の時刻定義を記載する [#1. 1. timeDefine](#1-1-1-timedefine)    |
| 1._3._2. | items         |      | **Array&lt;Object&gt;**<br/> 雨、雪、風（風雪）、波、潮位について警報級の現象になる可能性の内容と発表地域を記載する [#1. 3. 2. item](#1-1-3-2-item)  |
...
| 階層        | フィールド    | 出現条件        | 説明                                                             |
|-----------|----------|-------------|----------------------------------------------------------------|
| 1._1._1.  | timeId   |             | **String&lt;Integer&gt;**<br/> 時刻ID                            |
| 1._1._2.  | dateTime |             | **ISO8601Time**<br/> 予想する基準日時                                  |
| 1._1._3.  | duration |             | **String**<br/> 基準日時からの予想時間の幅を、 ISO8601 の Time intervals 形式で表す |
| 1._1._4.? | name     | VPFD60の場合のみ | **String**<br/> 時刻定義の内容                                        |
