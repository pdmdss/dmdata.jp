...
:::caution
2026年05月より開始する「気象防災速報 (VPBS50)」、「全般気象解説情報 (VPZJ51)」、「地方気象解説情報 (VPCJ51)」、「府県気象解説情報 (VPFJ51)」、
「全般気象解説情報（潮位） (VMCJ53)」、「地方気象解説情報（潮位） (VMCJ55)」、「府県気象解説情報（潮位） (VMCJ56)」を使用する場合は、新しいスキーマを参照してください。

[weather-commentary v1.0.0](/docs/reference/conversion/json/schema/weather-commentary.md)
:::

:::caution
「台風全般情報（総合情報、上陸等情報） (VPTI50) 」及び「発達する熱帯低気圧に関する情報 (VPTI51)」については、2026年05月より「全般気象情報 (VPZJ50)」へ統合されます。
:::
...
| 2.? | target  | VPFG50の場合のみ | **Object**<br/> 電文が対象とする地域を記載する  [#2. target](#2-target) |
