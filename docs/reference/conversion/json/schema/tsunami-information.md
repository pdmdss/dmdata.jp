...
* [津波警報・注意報・予報a (VTSE41)](/telegrams/et01110.md)
* [津波情報a (VTSE51)](/telegrams/et01120.md)
* [沖合の津波観測に関する情報 (VTSE52)](/telegrams/et01121.md)
...
| 2.? | earthquakes | 取消時には出現しない | **Array<Object\>**<br/> [Earthquake component](/reference/conversion/json/component.md#Earthquake-component) を配列に0個以上格納する |
...
| 階層 | フィールド | 出現条件 | 説明 |
| -- | -- | -- | -- |
| 1._1._4._1.? | arrivalTime | まだ津波が到達していない場合、<br/>到達していないと推測される場合に出現する | **String**<br/> 津波到達予想時刻、ISO8601の日本時間で記載する |
...
| 1._1._6._3. | highTideDateTime |  | **String**<br/> 満潮時刻、ISO8601の日本時間で記載する |
| 1._1._6._4. | firstHeight |  | **String**<br/> 満潮時刻、ISO8601の日本時間で記載する |
| 1._1._6._4._1.? | arrivalTime | まだ津波が到達していない場合、<br/>到達していないと推測される場合に出現する | **String**<br/> 津波到達予想時刻、ISO8601の日本時間で記載する |
...
| 1._2._3.? | stations |  | **Array<Object\>**<br/> 対象津波予報区に所属する潮位観測点毎の満潮時刻と到達予想時刻 [#1. 2. 3. station](#1-2-3-station) |
...
| 階層 | フィールド | 出現条件 | 説明 |
| -- | -- | -- | -- |
| 1._2._3._4._1.? | arrivalTime | 識別不能時は出現しない | **String**<br/> 津波の第一波の到達時刻、ISO8601の日本時間で記載する |
| 1._2._3._4._2.? | initial | 識別不能時は出現しない | **String**<br/> 津波の第一波の極性を記載する<br/> 取りうる値は `押し`、`引き` |
...
| 階層 | フィールド | 出現条件 | 説明 |
| -- | -- | -- | -- |
| 1._2._3._5._1.? | dateTime | 日時が明確である場合に出現 | **String**<br/> 津波の最大波を観測した日時、ISO8601の日本時間で記載する |
...
| 1._2._3._5._2._3. | value |  | **String<Float\>\|Null**<br/> 津波の最大波の高さ。 |
...
| 階層 | フィールド | 出現条件 | 説明 |
| -- | -- | -- | -- |
| 1._3._3._1. | arrivalTime |  | **String**<br/> 津波到達予想時刻、ISO8601の日本時間で記載する |
...
| 階層 | フィールド | 出現条件 | 説明 |
| -- | -- | -- | -- |
| 1._3._4._1.? | dateTime | 日時が明確である場合に出現 | **String**<br/> 津波の最大波となる日時（推定）、ISO8601の日本時間で記載する |
...
| 1._3._4._2._3. | value |  | **String<Float\>\|Null**<br/> 津波の最大波を推定した高さ。 |
