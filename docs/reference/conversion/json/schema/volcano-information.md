...
| 7._1._3.? | dubious | 情報による | **Object**<br/> 日時があいまいであることとして`頃`を記載する |
...
| 7._2._1._4.? | condition | value == **Null** 時 | **String**<br/> 噴煙高度がない場合は、 `噴煙なし` 又は `不明` とする |
...
| 7._2._2._4.? | condition | value == **Null** 時 | **String**<br/> 噴煙高度がない場合は、 `噴煙なし` 又は `不明` とする |
