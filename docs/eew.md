...
* eew.forecast (緊急地震（予報）区分)
  * [VXSE42 緊急地震速報（テスト）](/telegrams/ew09010)
  * [VXSE44 緊急地震速報（予報）](/telegrams/ew09030)
  * [VXSE45 緊急地震速報（地震動予報）](/telegrams/ew09040)（新形式） ※気象庁より提供され次第配信
* eew.warning (緊急地震（警報）区分)
  * [VXSE43 緊急地震速報（警報）](/telegrams/ew09020)
...
定義仕様は[こちら](/reference/conversion/json/schema/eew-information.md)。
